"""phishing_detection_system URL Configuration
...
from phishing_detection_system import settings
...
urlpatterns = [
    ...
    url(r'^View_Prediction_Of_URL_Type_Ratio/$', serviceprovider.View_Prediction_Of_URL_Type_Ratio, name="View_Prediction_Of_URL_Type_Ratio"),
